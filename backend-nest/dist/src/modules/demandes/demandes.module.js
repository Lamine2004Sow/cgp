...
const signalements_controller_1 = require("./signalements.controller");
...
exports.DemandesModule = DemandesModule = __decorate([
    (0, common_1.Module)({
        controllers: [signalements_controller_1.SignalementsController],
        providers: [signalements_service_1.SignalementsService],
    })
], DemandesModule);
