...
async function main() {
    ...
    const existingLicences = await prisma.entite_structure.findFirst({
        where: { id_annee: annee.id_annee, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Licences 2025-2030' },
    });
    let firstComposante;
    ...
    if (existingLicences) {
        ...
        const compLicences = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: null, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Licences 2025-2030', tel_service: null, bureau_service: null },
        });
        await prisma.composante.create({
            data: {
                id_entite: compLicences.id_entite,
                code_composante: null,
                type_composante: client_1.composante_type.UFR,
                site_web: null,
        ...
        const deptLicences = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: compLicences.id_entite, type_entite: client_1.entite_type.DEPARTEMENT, nom: 'Formations licence', tel_service: null, bureau_service: null },
        });
        ...
        for (const m of mentionsLicences) {
            const mentionE = await prisma.entite_structure.create({
                data: { id_annee: annee.id_annee, id_entite_parent: deptLicences.id_entite, type_entite: client_1.entite_type.MENTION, nom: m.nom, tel_service: null, bureau_service: null },
            });
            ...
            const parcoursE = await prisma.entite_structure.create({
                data: { id_annee: annee.id_annee, id_entite_parent: mentionE.id_entite, type_entite: client_1.entite_type.PARCOURS, nom: m.nom.replace('Licence Mention ', 'Licence '), tel_service: null, bureau_service: null },
            });
            ...
            for (const libNiveau of ['L1', 'L2', 'L3']) {
                const niveauE = await prisma.entite_structure.create({
                    data: { id_annee: annee.id_annee, id_entite_parent: parcoursE.id_entite, type_entite: client_1.entite_type.NIVEAU, nom: libNiveau, tel_service: null, bureau_service: null },
                });
    ...
    const existingIG = await prisma.entite_structure.findFirst({
        where: { id_annee: annee.id_annee, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Institut Galilée' },
    });
    if (!existingIG) {
        const compIG = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: null, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Institut Galilée', tel_service: '01 49 40 30 00', bureau_service: 'Bâtiment A' },
        });
        await prisma.composante.create({
            data: {
                id_entite: compIG.id_entite,
                code_composante: '903',
                type_composante: client_1.composante_type.INSTITUT,
        ...
        const deptIG = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: compIG.id_entite, type_entite: client_1.entite_type.DEPARTEMENT, nom: 'Département Informatique', tel_service: null, bureau_service: null },
        });
        ...
        const mentionIG = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: deptIG.id_entite, type_entite: client_1.entite_type.MENTION, nom: 'Mention Informatique', tel_service: null, bureau_service: null },
        });
        await prisma.mention.create({
        ...
        const parcoursIG = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: mentionIG.id_entite, type_entite: client_1.entite_type.PARCOURS, nom: 'Ingénierie Logicielle', tel_service: null, bureau_service: null },
        });
    ...
    const existingMastersDroit = await prisma.entite_structure.findFirst({
        where: { id_annee: annee.id_annee, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Masters Droit 2025-2030' },
    });
    if (!existingMastersDroit) {
        const compDroit = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: null, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Masters Droit 2025-2030', tel_service: null, bureau_service: null },
        });
        await prisma.composante.create({
            data: {
        ...
        const deptDroit = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: compDroit.id_entite, type_entite: client_1.entite_type.DEPARTEMENT, nom: 'Droit', tel_service: null, bureau_service: null },
        });
        ...
        for (const m of [
            ...
            const mentionE = await prisma.entite_structure.create({
                data: { id_annee: annee.id_annee, id_entite_parent: deptDroit.id_entite, type_entite: client_1.entite_type.MENTION, nom: m.nom, tel_service: null, bureau_service: null },
            });
            await prisma.mention.create({
            ...
            for (const nomP of m.parcours) {
                const parcoursE = await prisma.entite_structure.create({
                    data: { id_annee: annee.id_annee, id_entite_parent: mentionE.id_entite, type_entite: client_1.entite_type.PARCOURS, nom: nomP, tel_service: null, bureau_service: null },
                });
                await prisma.parcours.create({ data: { id_entite: parcoursE.id_entite, code_parcours: null } });
    ...
    const existingMastersScPo = await prisma.entite_structure.findFirst({
        where: { id_annee: annee.id_annee, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Masters Science Politique 2025-2030' },
    });
    if (!existingMastersScPo) {
        const compScPo = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: null, type_entite: client_1.entite_type.COMPOSANTE, nom: 'Masters Science Politique 2025-2030', tel_service: null, bureau_service: null },
        });
        await prisma.composante.create({
            data: {
        ...
        const deptScPo = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: compScPo.id_entite, type_entite: client_1.entite_type.DEPARTEMENT, nom: 'Science politique', tel_service: null, bureau_service: null },
        });
        ...
        const mentionScPo = await prisma.entite_structure.create({
            data: { id_annee: annee.id_annee, id_entite_parent: deptScPo.id_entite, type_entite: client_1.entite_type.MENTION, nom: 'Mention Science Politique', tel_service: null, bureau_service: null },
        });
        await prisma.mention.create({
        ...
        for (const nomP of [
            ...
            const parcoursE = await prisma.entite_structure.create({
                data: { id_annee: annee.id_annee, id_entite_parent: mentionScPo.id_entite, type_entite: client_1.entite_type.PARCOURS, nom: nomP, tel_service: null, bureau_service: null },
            });
            await prisma.parcours.create({ data: { id_entite: parcoursE.id_entite, code_parcours: null } });
            const libNiveau = nomP.startsWith('M1') ? 'M1' : 'M2';
            const niveauE = await prisma.entite_structure.create({
