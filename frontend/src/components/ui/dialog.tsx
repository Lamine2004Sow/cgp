...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-lg border border-slate-200 bg-white/90 p-1.5 text-slate-500 opacity-90 shadow-sm transition-colors hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
          <XIcon />
