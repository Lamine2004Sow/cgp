...
values
  ...
  ('vice-president-departement',             'Vice-président de département',          'Adjoint au chef de département',                 5,  true,  false, false),
  ...
  ('responsable-adjoint-service-pedagogique','Responsable adjoint service pédagogique','Appui au responsable service pédagogique',      6,  true,  true,  false),
